...
variable "build_validate_project_name" {
  type        = string
  description = "Build validate Project name for the prod codepipeline"
}

variable "build_apply_project_name" {
  type        = string
  description = "Build apply Project name for the prod codepipeline"
}

variable "approve_sns_arn" {
  type        = string
  description = "ARN of the prod SNS topic"
}
